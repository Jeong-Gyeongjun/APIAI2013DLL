...
namespace ai {
    ...
    private:
		...
		//static unsigned int write_callback(char *in, unsigned int size, unsigned int nmemb, std::string *response);
		static unsigned int write_callback(void *ptr, size_t size, size_t count, void *stream);
